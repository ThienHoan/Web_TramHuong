...
export class StorageService {
     ...
     * @param userId - The ID of the admin user uploading
     */
     ...
     * @param userId - The ID of the admin user deleting
     */
    async deleteProductImage(path: string, userId: string): Promise<void> {
