            ...
            <div className="max-w-[1600px] mx-auto px-6 lg:px-12">
                <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-16">
                    ...
                    <div className="md:col-span-4 lg:col-span-3">
                        ...
                        <a href="mailto:hello@tramhuong.vn" className="text-xs text-gray-600 dark:text-gray-400 hover:text-zen-secondary transition-colors font-light block font-zen-sans">hello@tramhuong.vn</a>
                    </div>
                </div>
                <div className="border-t border-zen-200/50 dark:border-zinc-800 pt-8 flex flex-col md:flex-row justify-between items-center text-[10px] uppercase tracking-widest text-gray-400 font-light font-zen-sans">
                    ...
                    <div className="flex space-x-8 mt-4 md:mt-0">
                        ...
                        <a href="#" className="hover:text-zen-secondary transition-colors">Facebook</a>
